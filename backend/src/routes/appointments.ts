...
import { validate, createAppointmentSchema, updateAppointmentSchema } from '../middleware/validate';
...
// Individual appointment operations - with ObjectId validation
router.get('/:id', requireStaff, validateObjectId('id'), (req, res) => appointmentController.getById(req as any, res));
...
router.post('/:id/checkin', requireStaff, validateObjectId('id'), (req, res) => appointmentController.checkIn(req as any, res));
...
router.put('/:id', requireDoctorOrAbove, validateObjectId('id'), validate(updateAppointmentSchema), (req, res) => appointmentController.update(req as any, res));

// Cancel - doctors, admins, and receptionists can cancel
router.delete('/:id', requireStaff, validateObjectId('id'), (req, res) => appointmentController.cancel(req as any, res));
