...
import { validate, createPatientSchema } from '../middleware/validate';
...
router.get('/:id', requireStaff, (req, res) => patientController.getById(req as any, res));
router.get('/:id/qr', requireStaff, (req, res) => patientController.getQrCode(req as any, res));
...
router.put('/:id', requireStaff, (req, res) => patientController.update(req as any, res));

// Delete - ADMIN ONLY!
router.delete('/:id', requireAdmin, (req, res) => patientController.delete(req as any, res));
